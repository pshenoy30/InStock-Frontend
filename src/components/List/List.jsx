    ...
    <>
      <MediaQuery maxWidth={767}>
        ...
        <Modal
          ...
          contentLabel="Delete a warehouse"
          ...
          <>
            ...
            <section className="list__modal__container">
              <article className="list__modal__text-container">
                ...
                <p className="list__modal__text">
                  Please confirm that you'd like to delete the {val1} from the
                  list of warehouses. You wont be able to undo this action
                </p>
              </article>
          ...
          <td className="list__actions">
            ...
            >
              <>
                ...
                <section className="list__modal__container">
                  <article className="list__modal__text-container">
                    <h1 className="list__modal__title">
                      Delete {val1} warehouse?
                    </h1>
                    <p1 className="list__modal__text">
                      Please confirm that you'd like to delete the {val1} from
                      the list of warehouses. You wont be able to undo this
                      action
                    </p1>
                  </article>
                  <article className="list__modal__button-container">
