...
function Table({ listData, listType, listheader }) {
  ...
  if (listType === "warehouse") {
    return (
      <>
        {modalData && (
          <Modal isOpen={isModalOpen} onRequestClose={closeModal} contentLabel="Delete a warehouse" ariaHideApp={false} className="modal">
            <>
    ...
    return (
      <>
        {modalData && (
          <Modal isOpen={isModalOpen} onRequestClose={closeModal} contentLabel="Delete an inventory item" className="modal">
            <>
              <button className='modal__close' onClick={closeModal}>
                <img className="img" src={closeImg} alt="close button"></img>
              </button>
              <section className='modal__container'>
                <article className='modal__text-container'>
                  <h1 className='modal__title'>Delete {modalData.itemName} inventory item?</h1>
                  <p className='modal__text'>Please confirm that you'd like to delete the {modalData.itemName} from the inventory list. You won't be able to undo this action.</p>
                </article>
                <article className='modal__button-container'>
                  <Buttons buttonName="Cancel" clickHandler={closeModal} />
                  <Buttons buttonName="Delete" clickHandler={deleteModal} />
