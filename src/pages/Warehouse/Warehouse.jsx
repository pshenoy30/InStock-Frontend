  ...
  return (
    <section className="warehouse">
      ...
      {warehouseDetails.map((warehouse) => {
        const {id, warehouse_name, address, city, country, contact_name, contact_phone, contact_email} = warehouse;
        return (
          <>
            <List id={id} title1="warehouse" val1={warehouse_name}  title2="Address" val2={address+city+country} title3="Contact Name" val3={contact_name} title4="Contact information" val4={contact_phone+contact_email} />
          </>
        )
      })}
    </section>
